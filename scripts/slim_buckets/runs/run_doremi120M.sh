...
REFERENCE_MODEL_NAME=${3:-"slim_baseline_50kvocab_nopack_bucket"}
OTHER_ARGS=$4
...
accelerate launch \
    ...
    --domain_config_path /home/wth/My_codes/doremi/configs/slim_uniform_bucket.json \
    ...
    --reference_model_name_or_path ${MODEL_OUTPUT_DIR}/${REFERENCE_MODEL_NAME}/checkpoint-50 \
    --bf16 \
    --shuffle \
