...
PREPROCESSED_DATA=${PREPROCESSED_MD_DIR}
...
NAME=md_main_r${ROUND}_120M_ref:${REFERENCE_WEIGHTS_NAME}_120M
accelerate launch \
    --config_file accelerate_config.yml \
    --num_machines 1 \
    --num_processes 8 \
    --multi_gpu \
    --main_process_port 60446 \
    ...
    --domain_config_path configs/md_doremi_r${ROUND}_120M_ref:${REFERENCE_WEIGHTS_NAME}_120M.json \
